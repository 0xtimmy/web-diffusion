...
import { unary, unaryWithAlpha, scalar, binary, binaryWithAlpha } from "./ops_high";
...
export function scalar_div(input: Tensor, alpha: number): Tensor {
    return scalar(functions.ScalarDivFunction, input, alpha);
}
export function scalar_add(input: Tensor, alpha: number): Tensor {
    return scalar(functions.ScalarAddFunction, input, alpha);
}
export function scalar_sub(input: Tensor, alpha: number): Tensor {
    return scalar(functions.ScalarSubFunction, input, alpha);
}
// min/max
export function min(input: Tensor, alpha: number): Tensor {
    return scalar(functions.MinFunction, input, alpha);
}
